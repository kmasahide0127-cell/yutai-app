...
export const YUTAI_LIST: Yutai[] = [
  ...
  { id: "8233", code: "8233", name: "高島屋", brands: ["高島屋", "タカシマヤ"], categories: ["小売", "百貨店"], lifestyleTags: ["百貨店利用", "プレゼント購入"], minShares: 100, approxInvestment: 230000, annualValue: 0, yieldPercent: 0.0, description: "10%割引カード(年間利用限度額あり)", rightsMonths: [2, 8], dataQuality: V, lastVerified: D },
  { id: "3099", code: "3099", name: "三越伊勢丹HD", brands: ["三越", "伊勢丹"], categories: ["小売", "百貨店"], lifestyleTags: ["百貨店利用", "プレゼント購入"], minShares: 100, approxInvestment: 230000, annualValue: 0, yieldPercent: 0.0, description: "10%割引カード(年間利用限度額あり)", rightsMonths: [3, 9], dataQuality: V, lastVerified: D },
  { id: "8242", code: "8242", name: "エイチ・ツー・オーリテイリング", brands: ["阪急百貨店", "阪神百貨店", "イズミヤ"], categories: ["小売", "百貨店"], lifestyleTags: ["百貨店利用", "関西住み"], minShares: 100, approxInvestment: 200000, annualValue: 0, yieldPercent: 0.0, description: "10%割引カード(阪急・阪神百貨店)", rightsMonths: [3, 9], dataQuality: V, lastVerified: D },

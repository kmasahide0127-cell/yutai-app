...
export const YUTAI_LIST: Yutai[] = [
  ...
  { id: "7867", code: "7867", name: "タカラトミー", brands: ["タカラトミー", "トミカ", "プラレール", "リカちゃん", "ベイブレード", "TOMY", "TAKARA TOMY"], categories: ["エンタメ", "小売"], lifestyleTags: ["子育て中", "ファミリー", "新生児", "ファミリーショッピング"], minShares: 100, approxInvestment: 300800, annualValue: 3000, yieldPercent: 1.0, description: "100株以上保有で年2回(3月・9月)、非売品オリジナル「トミカ」セットを贈呈(500株以上で4台、1,000株以上はリカちゃんも追加)。保有100株以上で公式通販「タカラトミーモール」を保有期間に応じ最大40%割引。優待価値は推定(現物商品のため)。", rightsMonths: [3, 9], dataQuality: V, lastVerified: "2026-06-25" },

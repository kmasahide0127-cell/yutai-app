...
export const PREFERENCE_TAGS: Record<ExpenseCategory, Array<{ id: PreferenceTag; label: string; emoji: string }>> = {
  ...
  "健康・スポーツ": [
    ...
    { id: "running", label: "ランニング・マラソン", emoji: "🏃" },
    { id: "cycling", label: "サイクリング", emoji: "🚴" },
  ],
  "交通・旅行": [
...
export function inferPreferenceTags(yutai: Yutai): PreferenceTag[] {
  ...
  const keywordMap: Record<PreferenceTag, string[]> = {
    ...
    "skincare": ["ファンケル", "dhc", "オルビス", "ノエビア", "ヤーマン", "ya-man"],
    ...
    "running": ["ランニング", "マラソン", "ジョギング", "アルペン", "ゼビオ", "ヴィクトリア", "ヒマラヤ", "セントラルスポーツ"],
    "cycling": ["サイクリング", "自転車", "スポーツバイク", "アルペン", "ゼビオ", "ヴィクトリア"],

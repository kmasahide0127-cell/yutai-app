    ...
    <div className="min-h-screen bg-background text-foreground px-4 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <section className="space-y-6 text-sm leading-relaxed">
          ...
          <div>
            <h2 className="font-semibold text-base mb-2">第3条(情報の正確性)</h2>
            <p>本サービスで提供される優待情報は、公開情報に基づき運営者が手作業で収集したものです。優待制度は予告なく変更・廃止される場合があり、本サービスの情報は最新でない可能性があります。実際の優待内容については、必ず各企業のIRページや公式発表で最新情報をご確認ください。</p>
          </div>
